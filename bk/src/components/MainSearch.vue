                ...
                <div class="form-group clearfix">
				 ...
				 <div class="form-group">
                    <form @submit.prevent="submitSearch" autocomplete="off">
                         <!-- <input type="text"  id="mainsearch" class="form-control bgserch" placeholder="Que recherchez-vous?" name=""> -->
                          <vue-google-autocomplete id="map"   types="(cities)" classname="form-control" :country="geocode" placeholder="Que recherchez-vous?" v-on:placechanged="getAddressData">
...
export default {
 ...
 this.user = JSON.parse(localStorage.getItem("tootellaUser"));
    ...
    mounted(){
        ...
        // this.$refs.address.update(this.user.city);
