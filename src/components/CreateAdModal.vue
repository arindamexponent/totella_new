    ...
    <div class="secoffer">
        ...
        <div class="boxstep1 stepbxoff" style="display: block;" v-if="stepView === 0">
            <div class="boxsteptwo">
                <div class="greywrp">
                    <div class="radio checkcategory  ctegorytheme catsmbox">
                        <h4 class="seltacategory text-center">Select a category</h4>
                            	<p class="sgcate">Suggested categories</p>
                        <div class="cateListnew">
            ...
            <div class="greywrp menuboxtoshow1">
                <div class="container">
                    <div class="catmenuList catmenuListrequest">
                        <ul class="list-unstyled menutxt menufirst form-group" id="myulid">
                            <li
                        ...
                        <div
                        <input type="button" value="Back" @click="backStep" class="btn btn-md btncs btnback backto1st btn-warning">
                        <input type="button" value="Done" @click="makeDone" class="btn btn-md btncs btndone2 pull-right btn-warning" v-if="doneBtn">
