            ...
            <div class="boxsteptwo">
                ...
                <div class="greywrp">
                    ...
                    <div class="text-center mrgt15">
                        <input type="button" value="Back" @click="backToRoot" class="btn btnback backto1st btn-md btncs btn-warning">
                    </div>
                    </div>
                </div>
            </div>
            ...
            <div class="greywrp menuboxtoshow1">
                <div class="container">
                    <div class="catmenuList catmenuListrequest">
                        ...
                        <input type="button" value="Back" @click="nextCategoryData(backParentId, 'B')" class="btn btn-md btncs btnback backto2nd btn-warning">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="boxstep4 stepbxoff" style="display: block;" v-if="$store.state.serviceStep == 3">
            <div class="stepfourwrap">
                <div class="boxform">
                    ...
                    <div class="clearfix">
                        <div class="radio checkcategory ctegorytheme pull-left">
